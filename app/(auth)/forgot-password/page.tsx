          ...
          <div className="w-full max-w-[400px]">
            {submitted ? (
              <div className="flex flex-col items-start">
                ...
                <Link
                  href="/login"
                  className="mt-6 font-grotesk text-[11px] uppercase tracking-widest text-[#2563eb] hover:text-[#3b82f6] transition-colors"
                >
                  ← Return to Sign In
                </Link>
              </div>
              ...
              <>
                ...
                <Link
                  href="/login"
                  className="mt-6 block font-grotesk text-[11px] uppercase tracking-widest text-[#2563eb] hover:text-[#3b82f6] transition-colors"
                >
                  ← Return to Sign In
                </Link>
              </>
